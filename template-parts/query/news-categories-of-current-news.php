...
<?php
            ...
            if (function_exists('udesly_set_frontend_editor_data') && wp_doing_ajax()) {
              udesly_set_frontend_editor_data('page-newss');
                ...
                global $post;
                $sub_posts_ids = get_the_terms( $post->ID, "news-category");
                $sub_posts = [];
                $limit = 100;
                $i = 1;
