...
$args = apply_filters('udesly/terms/chambers-sorted-by-name-v3', $args);

        $query = new WP_Term_Query($args);
?>
<div class="collection-list-wrapper-2 w-dyn-list" udy-collection="chamber">
                          ...
                          <?php foreach ($query->get_terms() as $term) : ?><div role="listitem" class="collection-item-4 w-dyn-item">
                            <a href="<?php echo get_term_link($term) ?>" class="product-list_single w-inline-block">
                              ...
                              <div class="product-list_right">
                                ...
                                <div class="text-size-small"><?php echo udesly_get_custom_term_field( $term->term_id, "tagline", "PlainText" ) ?></div>
                              </div>
                            </a>
                          </div><?php endforeach ?>
                        </div>
