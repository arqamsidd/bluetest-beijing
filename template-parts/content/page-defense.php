...
.db-filter-tag .w-dyn-item:nth-last-child(1) .db-filtertag::after{
  content: '';
                          ...
                          <div class="swiper-slides-container">
                            <div class="collection_featured swiper product-swiper">
                              <div class="swiper-wrapper">
                                ...
                                <a href="<?php echo _u('a62655c97','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide w-inline-block" data-link="a62655c97">
                      ...
                      <div class="swiper-slides-container">
                        <div class="collection_featured swiper product-swiper">
                          <div class="swiper-wrapper">
                            ...
                            <a href="<?php echo _u('a62655c97','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide squared w-inline-block" data-link="a62655c97">
                              <div class="sector_featured_image"><img src="<?php echo udesly_get_image(_u('in44fbe393', 'img'))->src ?>" loading="lazy" sizes="100vw" srcset="<?php echo udesly_get_image(_u('in44fbe393', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('in44fbe393', 'img'))->alt ?>" class="sector_featured_image-img" data-img="in44fbe393"></div>
                              <div class="sector_slider_content">
    ...
    <div class="home-hero hero-logo">
      <div class="fixed-bg"><img src="<?php echo udesly_get_image(_u('i17208e92', 'img'))->src ?>" loading="lazy" width="1512" sizes="(max-width: 1919px) 100vw, 1512px" alt="<?php echo udesly_get_image(_u('i17208e92', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i17208e92', 'img'))->srcset ?>" class="fixed-bg_img" data-img="i17208e92"></div>
      <div class="padding-global">
        <div class="container-large">
          <div class="home-hero_inner">
            <div class="home-hero_inner_bottom">
              <h1 id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49ef-e4fc4304" class="heading-style-h1 max-width-large" data-text="t385bf5da"><?php echo _u('t385bf5da','text'); ?></h1>
              <div id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f1-e4fc4304" class="home-hero_inner_bottom_right">
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f2-e4fc4304" href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon hero w-inline-block" data-link="a38b72420">
                  <div data-text="t7f2746de"><?php echo _u('t7f2746de','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <title>Arrow Right</title>
                      <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                ...
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6-e4fc4304" data-w-id="ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6" href="<?php echo _u('a6084ccde','link'); ?>" class="button is-icon gray special w-inline-block" data-link="a6084ccde">
    ...
    <div class="text-image">
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner"><img src="<?php echo udesly_get_image(_u('in1bdeaa31', 'img'))->src ?>" loading="lazy" width="500" sizes="(max-width: 767px) 100vw, 500px" alt="<?php echo udesly_get_image(_u('in1bdeaa31', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('in1bdeaa31', 'img'))->srcset ?>" class="text-image_img" data-img="in1bdeaa31">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="tn27fa89c1"><?php echo _u('tn27fa89c1','text'); ?></h2>
              <div data-textarea="tan3b32366d"><?php echo _u('tan3b32366d', 'textarea'); ?></div>
      ...
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner reversed">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="t5b53a607"><?php echo _u('t5b53a607','text'); ?></h2>
              <div data-textarea="ta75de84c1"><?php echo _u('ta75de84c1', 'textarea'); ?></div>
              <div class="text-image_text_bottom">
                <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                  <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
            ...
            </div><img src="<?php echo udesly_get_image(_u('in62a56f6b', 'img'))->src ?>" loading="lazy" width="1619.5" id="w-node-_2e37cf8f-8954-61ec-1673-1616b59e6c56-e4fc4304" alt="<?php echo udesly_get_image(_u('in62a56f6b', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('in62a56f6b', 'img'))->srcset ?>" sizes="(max-width: 1919px) 100vw, 1620px" class="text-image_img" data-img="in62a56f6b">
          </div>
        </div>
      </div>
    </div>
    <div class="solutions-slider">
      <div class="padding-global">
        <div class="container-large padding-section-medium">
          <h2 animated="" class="heading-style-h1 max-width-xlarge" data-text="t44b17b59"><?php echo _u('t44b17b59','text'); ?></h2>
                ...
                <div class="swiper-wrapper">
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card">
                      <div class="industry-card_image"><img src="<?php echo udesly_get_image(_u('i6f3ea4fa', 'img'))->src ?>" loading="lazy" sizes="(max-width: 3239px) 100vw, 3239px" srcset="<?php echo udesly_get_image(_u('i6f3ea4fa', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('i6f3ea4fa', 'img'))->alt ?>" class="industry-slider-card_img" data-img="i6f3ea4fa">
                        <div class="industry-card_tags">
                          <div data-text="tnd32bd50"><?php echo _u('tnd32bd50','text'); ?></div>
                          <div class="industry-pill" data-text="t4aaf454"><?php echo _u('t4aaf454','text'); ?></div>
                          <div class="industry-pill" data-text="t4aaf4d0"><?php echo _u('t4aaf4d0','text'); ?></div>
                          <div class="industry-pill" data-text="t4aaf50e"><?php echo _u('t4aaf50e','text'); ?></div>
                          <div class="industry-pill" data-text="t4aaf52d"><?php echo _u('t4aaf52d','text'); ?></div>
                        </div>
                      </div>
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="t785928cc"><?php echo _u('t785928cc','text'); ?></h3>
                        <div data-text="t4891f34e"><?php echo _u('t4891f34e','text'); ?></div>
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card">
                      ...
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="tn3ea16e27"><?php echo _u('tn3ea16e27','text'); ?></h3>
                        <div data-text="t363b97eb"><?php echo _u('t363b97eb','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="media-card">
      <div class="padding-global">
        <div class="container-large">
          <div class="media-card_bg"><img src="<?php echo udesly_get_image(_u('in6b2daa86', 'img'))->src ?>" loading="lazy" width="1619.5" sizes="(max-width: 1919px) 100vw, 1620px" alt="<?php echo udesly_get_image(_u('in6b2daa86', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('in6b2daa86', 'img'))->srcset ?>" class="media-card_img" data-img="in6b2daa86"></div>
          <div class="media-card_inner">
            <div class="media-card_content">
              <h2 animated="" class="fancy-h1" data-text="tn6302c36e"><?php echo _u('tn6302c36e','text'); ?></h2>
              <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                    <title>Arrow Right</title>
                      ...
                      <nav role="navigation" class="footer-nav w-nav-menu">
                        ...
                        <div data-hover="false" data-delay="0" class="dropdown-2 w-dropdown">
                          ...
                          <nav class="footer-nav_dropdown w-dropdown-list">
                            ...
                            <a href="<?php echo _u('a62655c97','link'); ?>" aria-current="page" class="footer-nav_link dropdown-child w-dropdown-link" data-text="tn40b1d9e0" data-link="a62655c97"><?php echo _u('tn40b1d9e0','text'); ?></a>
