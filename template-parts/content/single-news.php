...
.db-filter-tag .w-dyn-item:nth-last-child(1) .db-filtertag::after{
  content: '';
      ...
      <div class="padding-global">
        <div class="container-large padding-section-large">
          <div class="news-content_inner">
            <div class="news-content_left">
              <div sym-bind="fc77a953-120c-4a42-d789-2be51c93fc34" class="f-spacegrotesk text-color-gray"><?php echo date_format(date_create(udesly_get_custom_post_field( $post->ID, "date", "Date" )), "F d, Y"); ?></div>
              <div class="breadcrumbs">
                <a href="<?php echo _u('a2f','link'); ?>" class="breadcrumb" data-text="t2268ff" data-link="a2f"><?php echo _u('t2268ff','text'); ?></a>
                <div class="breadcrumb-divider" data-text="t2f"><?php echo _u('t2f','text'); ?></div>
                <a href="<?php echo _u('a63dd000','link'); ?>" class="breadcrumb" data-text="t24fef3" data-link="a63dd000"><?php echo _u('t24fef3','text'); ?></a>
                <div class="breadcrumb-divider" data-text="t2f"><?php echo _u('t2f','text'); ?></div>
                <div class="breadcrumb-text"><?php the_title() ?></div>
              </div><img src="<?php echo udesly_get_image()->src ?>" loading="lazy" alt="<?php echo udesly_get_image()->alt ?>" class="news-content_featured_img" data-img="in33e257ca" srcset="<?php echo udesly_get_image()->srcset ?>">
            </div>
            <div class="news-content_right">
              <h1 class="heading-style-h2"><?php the_title() ?></h1>
              <div class="text-weight-semibold"><?php echo udesly_get_custom_post_field( $post->ID, "intro-line", "PlainText" ) ?></div>
              <div class="news-introtext"><?php the_excerpt() ?></div>
              <div class="text-rich-text w-richtext" data-richtext="r3fbe8166"><?php the_content() ?></div>
    ...
    <div class="news-loop-all related">
      <div class="padding-global">
        <div class="container-large">
          <div class="related-news_top">
            <h2 data-text="tn6d71d71e"><?php echo _u('tn6d71d71e','text'); ?></h2>
            <a href="<?php echo _u('a63dd000','link'); ?>" class="button is-text black w-inline-block" data-link="a63dd000">
              <div data-text="t6b8f4212"><?php echo _u('t6b8f4212','text'); ?></div>
          ...
          <?php get_template_part('template-parts/query/news-max-3-where-id-ne-current-sorted-by-date') ?>
        </div>
      </div>
    </div>
