        ...
        <div class="container-large padding-section-medium">
          <div class="tech-content">
            <div class="breadcrumbs">
              ...
              <a href="<?php echo _u('a-1ef6e313','link'); ?>" class="breadcrumb" data-text="t12b9612c" data-link="a-1ef6e313"><?php echo _u('t12b9612c','text'); ?></a>
              <div class="breadcrumb-divider" data-text="t2f"><?php echo _u('t2f','text'); ?></div>
              <div class="breadcrumb-text"><?php the_title() ?></div>
            </div>
            <h1 class="heading-style-h2 tech-heading"><?php the_title() ?></h1>
            <div class="text-weight-semibold"><?php echo udesly_get_custom_post_field( $post->ID, "inner-heading", "PlainText" ) ?></div>
            <div class="news-introtext text-rich-text w-richtext" data-richtext="r3fbe8166"><?php the_content() ?></div>
            <div fs-richtext-element="rich-text" class="text-rich-text w-richtext" data-richtext="r3fbe8166"><?php echo udesly_get_custom_post_field( $post->ID, "main-content", "RichText" ) ?></div>
