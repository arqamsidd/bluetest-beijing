      ...
      <div class="padding-global">
        <div class="container-medium">
          <div class="policy-inner">
            <h1 class="heading-style-h2" data-text="tn654e4dcc"><?php echo _u('tn654e4dcc','text'); ?></h1>
            <div class="text-rich-text w-richtext" data-richtext="r45c8b47e"><?php echo _u('r45c8b47e', 'richtext'); ?></div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="footer_inner">
            ...
            <div class="footer_bottom">
              <ul role="list" class="footer_privacy_menu">
                ...
                <li>
                  <a href="<?php echo _u('a3e9d8061','link'); ?>" aria-current="page" class="unstyle" data-text="t64169e54" data-link="a3e9d8061"><?php echo _u('t64169e54','text'); ?></a>
                </li>
              </ul>
            </div>
          </div>
