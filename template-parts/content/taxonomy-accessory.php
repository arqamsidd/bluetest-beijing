...
.db-filter-tag .w-dyn-item:nth-last-child(1) .db-filtertag::after{
  content: '';
    ...
    <div class="w-embed">
      <style>
.accessory-gallery .swiper-pagination{
  bottom: unset;
  top: 0;
}
</style>
    ...
    <div class="accessory-hero">
      <div class="padding-global">
        <div class="container-large">
          <div class="accessory-hero_inner">
            <div class="accessory-hero_left">
              <div class="accessory-info_top">
                <?php get_template_part('template-parts/query/accessory-categories-of-current-accessory-v0') ?>
                <h1 class=""><?php echo $term->name; ?></h1>
                <div class="accessory-info text-rich-text w-richtext" data-richtext="r3fbe8166"><?php echo udesly_get_custom_term_field( $term->term_id, "description", "RichText" ) ?></div>
              </div>
              <div class="accessory-info_bottom">
                <h2 class="text-size-small text-color-gray"><?php echo udesly_get_custom_term_field( $term->term_id, "features-heading", "PlainText" ) ?></h2>
                <?php get_template_part('template-parts/query/accessory-features-where-accessory-eq-current') ?>
              </div>
            </div>
            <div class="product-hero_right">
              <div class="accessory-gallery">
                <?php $setItems = (array) udesly_get_custom_term_field( get_queried_object_id(), "gallery", "Set" ) ?><div class="swiper accessory-slider w-dyn-list">
                  <div role="list" class="swiper-wrapper w-dyn-items" data-appended="true">
                    <?php foreach ($setItems as $setItem) : ?><div role="listitem" class="swiper-slide w-dyn-item"><img src="<?php echo $setItem['image']->src ?>" loading="lazy" alt="<?php echo $setItem['image']->alt ?>" class="accessory-hero-image" data-img="in3092cd69" srcset="<?php echo $setItem['image']->srcset ?>"></div><?php endforeach ?>
                  <?php $setItem = udesly_get_fake_set_item(); ?><template><div role="listitem" class="swiper-slide w-dyn-item udesly-hidden" data-repeater-prop="item"><img src="<?php echo $setItem['image']->src ?>" loading="lazy" alt="<?php echo $setItem['image']->alt ?>" class="accessory-hero-image" data-img="in3092cd69" srcset="<?php echo $setItem['image']->srcset ?>"></div></template></div>
              ...
              <div class="accessory-button">
                <?php if (udesly_get_custom_term_field( $term->term_id, "more-info", "FileRef" )) : ?><a id="w-node-_0cba7722-4577-283b-ad9f-2528d80f8310-b7228c79" href="<?php echo wp_get_attachment_url( udesly_get_custom_term_field( get_queried_object_id(), "more-info", "FileRef" ) ) ?>" class="button is-icon stretch w-inline-block">
