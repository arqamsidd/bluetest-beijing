...
.product-card-stats .w-richtext li{
  ...
  display: inline-block;
    ...
    <div class="product-hero">
      <div style="display:block" class="view-video-link-outer">
        <div class="padding-global">
          <div class="container-large">
            <div class="view-video-link-inner">
              <div data-w-id="f8ced042-9f48-d0e2-ba4d-b8522e2f514b" class="close"><img src="<?php echo udesly_get_image(_u('i2a5863b0', 'img'))->src ?>" loading="lazy" alt="<?php echo udesly_get_image(_u('i2a5863b0', 'img'))->alt ?>" class="image-2" data-img="i2a5863b0" srcset="<?php echo udesly_get_image(_u('i2a5863b0', 'img'))->srcset ?>"></div>
              <a href="<?php echo _u('a4269b238','link'); ?>" class="playlink w-inline-block" data-link="a4269b238">
                <div class="button-left"><img src="<?php echo udesly_get_image(_u('id409676', 'img'))->src ?>" loading="lazy" alt="<?php echo udesly_get_image(_u('id409676', 'img'))->alt ?>" class="play-icon" data-img="id409676" srcset="<?php echo udesly_get_image(_u('id409676', 'img'))->srcset ?>"><img src="<?php echo udesly_get_custom_term_field( $term->term_id, "yt-gif", "ImageRef" )->src ?>" loading="lazy" alt="<?php echo udesly_get_custom_term_field( $term->term_id, "yt-gif", "ImageRef" )->alt ?>" class="background-gif" data-img="i317f733b" srcset="<?php echo udesly_get_custom_term_field( $term->term_id, "yt-gif", "ImageRef" )->srcset ?>"></div>
                <div class="text-block-4" data-text="t3a09ffc8"><?php echo _u('t3a09ffc8','text'); ?></div>
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="padding-global z-index-1">
        <div class="container-large">
          <div class="product-hero_inner">
            <div class="product-hero_left">
              <div class="product-hero-left_top">
                <h1 class="heading-fancy-xxl"><?php echo $term->name; ?></h1>
                ...
                <div class="f-spacegrotesk w-richtext" data-richtext="r3fbe8166"><?php echo udesly_get_custom_term_field( $term->term_id, "short-description-2", "RichText" ) ?></div>
              </div>
              <div class="product-hero_left_bottom max-width-small">
                <div class="product-hero_instock_wrap">
                  <div class="pill-tag gray" data-text="t750f0c5f"><?php echo _u('t750f0c5f','text'); ?></div>
                  <div class="product-hero_instock_markets">
                    <h4 class="heading-style-h5" data-text="t208744"><?php echo _u('t208744','text'); ?></h4>
                    <h4 class="heading-style-h5" data-text="tn66fb37bb"><?php echo _u('tn66fb37bb','text'); ?></h4>
                    <h4 class="heading-style-h5" data-text="tn6ba169f4"><?php echo _u('tn6ba169f4','text'); ?></h4>
                    <h4 class="heading-style-h5" data-text="t66275133"><?php echo _u('t66275133','text'); ?></h4>
                  </div>
                </div>
                <div class="f-spacegrotesk text-color-gray" data-text="tn4ff3fbac"><?php echo _u('tn4ff3fbac','text'); ?></div>
              </div>
            </div>
            <div class="product-hero_right">
              <div class="home-hero_inner_bottom_right margin-top no-col product">
                <a id="w-node-_7c19931c-d226-b37e-5cd1-c5927b0d69af-018225a1" href="<?php echo _u('a38b72420','link'); ?>" class="button-xl is-icon left w-inline-block" data-link="a38b72420">
...
if ((!udesly_referenced_item_contains($post->post_name, ["rts25"]))) {
 /* Result: true */

$conditionResult = true;

} ?><?php if ($conditionResult) : ?><a id="w-node-_7c19931c-d226-b37e-5cd1-c5927b0d69b3-018225a1" href="<?php echo wp_get_attachment_url( udesly_get_custom_term_field( get_queried_object_id(), "datasheet-file", "FileRef" ) ) ?>" class="button-xl is-icon white r w-inline-block">
      ...
      </div><img src="<?php echo udesly_get_custom_term_field( $term->term_id, "hero-image", "ImageRef" )->src ?>" loading="lazy" alt="<?php echo udesly_get_custom_term_field( $term->term_id, "hero-image", "ImageRef" )->alt ?>" class="product-hero_image" data-img="i356946b4" srcset="<?php echo udesly_get_custom_term_field( $term->term_id, "hero-image", "ImageRef" )->srcset ?>">
    </div>
    <div class="product-body">
      <div class="padding-global">
        <div class="container-large padding-section-large">
          <div class="product-body_inner">
            <div class="product-body_left">
              <div class="product-gallery">
                <?php $setItems = (array) udesly_get_custom_term_field( get_queried_object_id(), "product-gallery", "Set" ) ?><div class="w-dyn-list">
                  <div role="list" class="product-gallery w-dyn-items" data-appended="true">
                    <?php foreach ($setItems as $setItem) : ?><div role="listitem" class="w-dyn-item">
                      <a href="#" class="w-inline-block w-lightbox"><img src="<?php echo $setItem['image']->src ?>" loading="lazy" alt="<?php echo $setItem['image']->alt ?>" class="product-gallery_img" data-img="in1f8299d7" srcset="<?php echo $setItem['image']->srcset ?>">
                        <script type="application/json" class="w-json">{"items":[{"type":"image","url":"<?php echo $setItem['image']->src; ?>","caption":"<?php echo $setItem['image']->caption ?>"}],"group":"ChamberGallery"}</script>
                      </a>
                    </div><?php endforeach ?>
                  <?php $setItem = udesly_get_fake_set_item(); ?><template><div role="listitem" class="w-dyn-item udesly-hidden" data-repeater-prop="item">
                      <a href="#" class="w-inline-block w-lightbox"><img src="<?php echo $setItem['image']->src ?>" loading="lazy" alt="<?php echo $setItem['image']->alt ?>" class="product-gallery_img" data-img="in1f8299d7" srcset="<?php echo $setItem['image']->srcset ?>">
                        <script type="application/json" class="w-json">{"items":[{"type":"image","url":"<?php echo $setItem['image']->src; ?>","caption":"<?php echo $setItem['image']->caption ?>"}],"group":"ChamberGallery"}</script>
                      </a>
                    </div></template></div>
            ...
            <div id="w-node-e1c9ff7b-62e5-2004-b5de-b215635790bc-018225a1" class="product-body_right">
              <h2 class=""><?php echo udesly_get_custom_term_field( $term->term_id, "body-text-heading", "PlainText" ) ?></h2>
              <div class="text-rich-text w-richtext" data-richtext="r3fbe8166"><?php echo udesly_get_custom_term_field( $term->term_id, "body-text", "RichText" ) ?></div>
              <div class="product-body_features">
                <div class="f-spacegrotesk text-color-gray"><?php echo udesly_get_custom_term_field( $term->term_id, "key-features-heading", "PlainText" ) ?></div>
                <?php get_template_part('template-parts/query/chamber-key-features-where-chamber-eq-current-sorted-by-order') ?>
              </div>
              <div class="home-hero_inner_bottom_right margin-top no-col product">
                <a id="w-node-_811eda71-f306-0beb-1e26-003203e5b623-018225a1" href="<?php echo _u('a38b72420','link'); ?>" class="button-xl is-icon left w-inline-block" data-link="a38b72420">
                  <div data-text="tn5b4fbf75"><?php echo _u('tn5b4fbf75','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <title>Arrow Right</title>
                      <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
...
$conditionResult = true;
...
} ?><?php if ($conditionResult) : ?><a id="w-node-_811eda71-f306-0beb-1e26-003203e5b627-018225a1" href="<?php echo wp_get_attachment_url( udesly_get_custom_term_field( get_queried_object_id(), "datasheet-file", "FileRef" ) ) ?>" class="button-xl is-icon white r w-inline-block">
                  <div data-text="tn6e277039"><?php echo _u('tn6e277039','text'); ?></div>
                  <div class="global-icon-x-small w-embed"><svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M6.52958 -2.62235e-07L6.52984 12M6.52984 12L12.5288 6.00061M6.52984 12L0.530451 6.00061" stroke="currentColor" stroke-width="1.5" stroke-linejoin="bevel"></path>
                      <path d="M0.529297 14.5L2.0293 15.5H11.0293L12.5293 14.5" stroke="currentColor" stroke-width="1.5" stroke-linejoin="bevel"></path>
    ...
    <div class="text-image">
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner"><img src="<?php echo udesly_get_custom_term_field( $term->term_id, "second-image-text-image", "ImageRef" )->src ?>" loading="lazy" alt="<?php echo udesly_get_custom_term_field( $term->term_id, "second-image-text-image", "ImageRef" )->alt ?>" class="text-image_img cms" data-img="in33eb99ec" srcset="<?php echo udesly_get_custom_term_field( $term->term_id, "second-image-text-image", "ImageRef" )->srcset ?>">
            <div class="text-image_text">
              <h2 class="heading-style-h3"><?php echo udesly_get_custom_term_field( $term->term_id, "second-image-text-heading", "PlainText" ) ?></h2>
              <div class="text-rich-text w-richtext" data-richtext="r3fbe8166"><?php echo udesly_get_custom_term_field( $term->term_id, "second-image-text-content", "RichText" ) ?></div>
    ...
    <div id="video" class="video-outer">
      <div class="padding-global">
        <div class="container-large">
          <div class="spacer-huge"></div>
          <div class="video-holder">
            <div class="video-embed w-embed w-iframe"><iframe width="100%" height="100%" src="<?php echo udesly_get_custom_term_field( get_queried_object_id(), "chamber-video-embed", "PlainText" ) ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
          </div>
          <div class="spacer-huge"></div>
        </div>
      </div>
