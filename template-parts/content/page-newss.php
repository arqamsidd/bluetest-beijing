          ...
          <div class="navigation-container">
            ...
            <div class="navigation-right">
              <nav role="navigation" class="nav-menu w-nav-menu">
                ...
                <a href="<?php echo _u('a63dd000','link'); ?>" aria-current="page" class="navigation-link w-nav-link" data-text="t74af045" data-link="a63dd000"><?php echo _u('t74af045','text'); ?></a>
      ...
      <div class="padding-global">
        <div class="container-large">
          <div class="text-hero_inner max-width-large">
            <h1 data-text="t512b4db5"><?php echo _u('t512b4db5','text'); ?></h1>
            <div class="f-spacegrotesk" data-textarea="tan3d8ddac"><?php echo _u('tan3d8ddac', 'textarea'); ?></div>
            ...
            <div class="home-hero_inner_bottom_right">
              <a id="w-node-_0bb73172-5163-9c97-0428-bc8415c09997-77ed9f98" href="<?php echo _u('a38b72420','link'); ?>" class="button is-icon w-inline-block" data-link="a38b72420">
                <div data-text="t7f2746de"><?php echo _u('t7f2746de','text'); ?></div>
                <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                    <title>Arrow Right</title>
                    <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                  ...
                  <div class="footer_left_menu_top">
                    ...
                    <div data-animation="default" data-collapse="none" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="footer-nav_wrap w-nav">
                      <nav role="navigation" class="footer-nav w-nav-menu">
                        ...
                        <a href="<?php echo _u('a63dd000','link'); ?>" aria-current="page" class="footer-nav_link w-nav-link" data-text="t2cdea0c5" data-link="a63dd000"><?php echo _u('t2cdea0c5','text'); ?></a>
