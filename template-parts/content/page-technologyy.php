          ...
          <div class="navigation-container">
            ...
            <div class="navigation-right">
              <nav role="navigation" class="nav-menu w-nav-menu">
                ...
                <a href="<?php echo _u('a-1ef6e313','link'); ?>" aria-current="page" class="navigation-link w-nav-link" data-text="t12b9612c" data-link="a-1ef6e313"><?php echo _u('t12b9612c','text'); ?></a>
      ...
      <div data-animation="default" class="navigation-mob w-nav" data-easing2="ease-out" data-easing="ease-out" data-collapse="medium" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
        <div class="navigation-container-mob">
          ...
          <nav role="navigation" class="mobile-nav w-nav-menu">
            ...
            <a href="<?php echo _u('a-1ef6e313','link'); ?>" aria-current="page" class="mobile-nav-link w-nav-link" data-text="t12b9612c" data-link="a-1ef6e313"><?php echo _u('t12b9612c','text'); ?></a>
      ...
      <div class="padding-global">
        <div class="container-large">
          <div class="text-hero_inner max-width-xlarge">
            <h1 data-text="tn8d76508"><?php echo _u('tn8d76508','text'); ?></h1>
            <div class="f-spacegrotesk max-width-large" data-textarea="tan6edcf7e"><?php echo _u('tan6edcf7e', 'textarea'); ?></div>
          </div>
        </div>
      </div>
    </div>
    <div class="database-loop-all">
      <div class="padding-global">
        <div class="container-large">
              ...
              <form id="wf-form-DB" name="wf-form-Accessories" data-name="Accessories" method="get" fs-list-element="filters" class="db-filter-form" data-wf-page-id="6969514e9fe7e572d82e2639" data-wf-element-id="4e90d1aa-2e82-cc7f-8c3c-767af27e710b" data-ajax-action="contact"><label for="contact[email]">Email</label><input type="email" name="contact[email]" class="w-input" required="">
                <div class="db-filter-left">
                  <div class="db-filterby">
                    <div>Filter by: </div>
                    <a fs-list-element="clear" href="<?php echo _u('a23','link'); ?>" class="db-filterby-btn db-categ active" data-link="a23">Category</a>
                    <a fs-list-element="clear" href="<?php echo _u('a23','link'); ?>" class="db-filterby-btn db-tag" data-link="a23">Tags</a>
                  </div>
                  <div class="db-filter-category">
                    <?php get_template_part('template-parts/query/technology-categories') ?>
                  </div>
                  <div class="db-filter-tag">
                    <?php get_template_part('template-parts/query/technology-tags-sorted-by-name') ?>
                  </div>
                </div>
                <div class="db-filter-right">
                  <div class="form-row_child technology"><label for="contact[first-name]">First name</label><input class="career-input w-input" maxlength="256" fs-list-field="category, title, tag, description" name="contact[first-name]" data-name="First name" placeholder="Search database" type="text" id="First-name">
                    <div class="code-embed w-embed"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="29" height="29" rx="5" fill="#1477FF"></rect>
                        <path d="M20.7 21.75L15.975 17.025C15.6 17.325 15.1688 17.5625 14.6813 17.7375C14.1938 17.9125 13.675 18 13.125 18C11.7625 18 10.6095 17.528 9.666 16.584C8.7225 15.64 8.2505 14.487 8.25 13.125C8.2495 11.763 8.7215 10.61 9.666 9.666C10.6105 8.722 11.7635 8.25 13.125 8.25C14.4865 8.25 15.6398 8.722 16.5848 9.666C17.5298 10.61 18.0015 11.763 18 13.125C18 13.675 17.9125 14.1937 17.7375 14.6812C17.5625 15.1687 17.325 15.6 17.025 15.975L21.75 20.7L20.7 21.75ZM13.125 16.5C14.0625 16.5 14.8595 16.172 15.516 15.516C16.1725 14.86 16.5005 14.063 16.5 13.125C16.4995 12.187 16.1715 11.3903 15.516 10.7348C14.8605 10.0793 14.0635 9.751 13.125 9.75C12.1865 9.749 11.3898 10.0773 10.7348 10.7348C10.0798 11.3923 9.7515 12.189 9.75 13.125C9.7485 14.061 10.0768 14.858 10.7348 15.516C11.3928 16.174 12.1895 16.502 13.125 16.5Z" fill="white"></path>
                      </svg></div>
                  </div>
                  <div class="db-filter-layout">
                    <div class="db-layout db-layout-list active w-embed"><svg width="46" height="27" viewBox="0 0 46 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="45.9505" height="6.82433" fill="currentColor"></rect>
                        <rect y="10.0088" width="45.9505" height="6.82433" fill="currentColor"></rect>
                        <rect y="20.0176" width="45.9505" height="6.82433" fill="currentColor"></rect>
                      </svg></div>
                    <div class="db-layout db-layout-grid w-embed"><svg width="46" height="27" viewBox="0 0 46 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="21.3829" height="12.0563" fill="currentColor"></rect>
                        <rect y="14.5576" width="21.3829" height="12.0563" fill="currentColor"></rect>
                        <rect x="24.5674" width="21.3829" height="12.0563" fill="currentColor"></rect>
                        <rect x="24.5674" y="14.5576" width="21.3829" height="12.0563" fill="currentColor"></rect>
                      </svg></div>
                  </div>
                </div>
          ...
          <?php get_template_part('template-parts/query/technologies') ?>
        </div>
      </div>
    </div>
                  ...
                  <div class="footer_left_menu_top">
                    ...
                    <div data-animation="default" data-collapse="none" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="footer-nav_wrap w-nav">
                      <nav role="navigation" class="footer-nav w-nav-menu">
                        ...
                        <a href="<?php echo _u('a-1ef6e313','link'); ?>" aria-current="page" class="footer-nav_link w-nav-link" data-text="t12b9612c" data-link="a-1ef6e313"><?php echo _u('t12b9612c','text'); ?></a>
