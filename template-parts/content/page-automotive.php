...
.db-filter-tag .w-dyn-item:nth-last-child(1) .db-filtertag::after{
  content: '';
                          ...
                          <div class="swiper-slides-container">
                            <div class="collection_featured swiper product-swiper">
                              <div class="swiper-wrapper">
                                ...
                                <a href="<?php echo _u('a-6999a2c2','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide w-inline-block" data-link="a-6999a2c2">
                      ...
                      <div class="swiper-slides-container">
                        <div class="collection_featured swiper product-swiper">
                          <div class="swiper-wrapper">
                            ...
                            <a href="<?php echo _u('a-6999a2c2','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide squared w-inline-block" data-link="a-6999a2c2">
                              <div class="sector_featured_image"><img src="<?php echo udesly_get_image(_u('i573004aa', 'img'))->src ?>" loading="lazy" sizes="100vw" srcset="<?php echo udesly_get_image(_u('i573004aa', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('i573004aa', 'img'))->alt ?>" class="sector_featured_image-img" data-img="i573004aa"></div>
                              <div class="sector_slider_content">
                                <div class="heading-style-h4 sectorcard-heading" data-text="tn73e4c4eb"><?php echo _u('tn73e4c4eb','text'); ?></div>
                                <div class="global-icon-x-small sectorcard w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <div class="home-hero hero-logo">
      <div class="fixed-bg"><img src="<?php echo udesly_get_image(_u('i10e489e1', 'img'))->src ?>" loading="lazy" width="1376" sizes="(max-width: 1919px) 100vw, 1376px" alt="<?php echo udesly_get_image(_u('i10e489e1', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i10e489e1', 'img'))->srcset ?>" class="fixed-bg_img" data-img="i10e489e1"></div>
      <div class="padding-global">
        <div class="container-large">
          <div class="home-hero_inner">
            <div class="home-hero_inner_bottom">
              <h1 id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49ef-73a98538" class="heading-style-h1 max-width-large" data-text="t2c6c48b3"><?php echo _u('t2c6c48b3','text'); ?></h1>
              <div id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f1-73a98538" class="home-hero_inner_bottom_right">
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f2-73a98538" href="<?php echo _u('a38b72420','link'); ?>" class="button is-icon hero w-inline-block" data-link="a38b72420">
                  <div data-text="t7f2746de"><?php echo _u('t7f2746de','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <title>Arrow Right</title>
                      <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                ...
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6-73a98538" data-w-id="ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6" href="<?php echo _u('a6084ccde','link'); ?>" class="button is-icon gray special w-inline-block" data-link="a6084ccde">
    ...
    <div class="text-image">
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner"><img src="<?php echo udesly_get_image(_u('i573004aa', 'img'))->src ?>" loading="lazy" sizes="(max-width: 5504px) 100vw, 5504px" srcset="<?php echo udesly_get_image(_u('i573004aa', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('i573004aa', 'img'))->alt ?>" class="text-image_img" data-img="i573004aa">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="tn152e848f"><?php echo _u('tn152e848f','text'); ?></h2>
              <div data-textarea="tan9e18b54"><?php echo _u('tan9e18b54', 'textarea'); ?></div>
      ...
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner reversed">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="t1b51932e"><?php echo _u('t1b51932e','text'); ?></h2>
              <div data-text="t4f030c40"><?php echo _u('t4f030c40','text'); ?></div>
              <div class="text-image_text_bottom">
                <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                  <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
            ...
            </div><img src="<?php echo udesly_get_image(_u('i3a5869b9', 'img'))->src ?>" loading="lazy" id="w-node-_2e37cf8f-8954-61ec-1673-1616b59e6c56-73a98538" sizes="(max-width: 3239px) 100vw, 3239px" alt="<?php echo udesly_get_image(_u('i3a5869b9', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i3a5869b9', 'img'))->srcset ?>" class="text-image_img" data-img="i3a5869b9">
          </div>
        </div>
      </div>
    </div>
    <div class="text-image">
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner"><img src="<?php echo udesly_get_image(_u('i745d2ed7', 'img'))->src ?>" loading="lazy" sizes="(max-width: 3239px) 100vw, 3239px" srcset="<?php echo udesly_get_image(_u('i745d2ed7', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('i745d2ed7', 'img'))->alt ?>" class="text-image_img" data-img="i745d2ed7">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="t2275ae84"><?php echo _u('t2275ae84','text'); ?></h2>
              <div data-text="tn337b7854"><?php echo _u('tn337b7854','text'); ?></div>
              <div class="text-image_text_bottom">
                <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                  <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="solutions-slider hide">
      <div class="padding-global">
        <div class="container-large padding-section-medium">
          <h2 class="heading-style-h1 max-width-xlarge" data-text="tn273b05e2"><?php echo _u('tn273b05e2','text'); ?></h2>
                ...
                <div class="swiper-wrapper">
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card">
                      <div class="industry-card_image"><img src="<?php echo udesly_get_image(_u('in38b8d9ca', 'img'))->src ?>" loading="lazy" sizes="100vw" srcset="<?php echo udesly_get_image(_u('in38b8d9ca', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('in38b8d9ca', 'img'))->alt ?>" class="industry-slider-card_img" data-img="in38b8d9ca">
                      ...
                      <div class="industry-slider-card_content">
                        ...
                        <div class="industry-card_buttons">
                          ...
                          <a href="<?php echo _u('a23','link'); ?>" class="button is-text w-inline-block" data-link="a23">
                    ...
                    <div class="industry-slider-card">
                      ...
                      <div class="industry-slider-card_content">
                        ...
                        <div class="industry-card_buttons">
                          ...
                          <a href="<?php echo _u('a45e','link'); ?>" target="_blank" class="button is-text w-inline-block" data-link="a45e">
                            <div data-text="t31997f7f"><?php echo _u('t31997f7f','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                                <title>Arrow Right</title>
                                <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card">
                      ...
                      <div class="industry-slider-card_content">
                        ...
                        <div data-text="t83e764a"><?php echo _u('t83e764a','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="media-card">
      <div class="padding-global">
        <div class="container-large black">
          <div class="media-card_bg"><img src="<?php echo udesly_get_image(_u('i50cae08b', 'img'))->src ?>" loading="lazy" width="1376" sizes="(max-width: 1919px) 100vw, 1376px" alt="<?php echo udesly_get_image(_u('i50cae08b', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i50cae08b', 'img'))->srcset ?>" class="media-card_img opacity-less" data-img="i50cae08b"></div>
          <div class="media-card_inner">
            <div class="media-card_content">
              <h2 class="fancy-h1" data-textarea="tan11e31c77"><?php echo _u('tan11e31c77', 'textarea'); ?></h2>
              <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                    <title>Arrow Right</title>
    ...
    <div class="partner-logos gray hide">
      <div class="padding-global">
        <div class="container-large">
                      ...
                      <nav role="navigation" class="footer-nav w-nav-menu">
                        ...
                        <div data-hover="false" data-delay="0" class="dropdown-2 w-dropdown">
                          ...
                          <nav class="footer-nav_dropdown w-dropdown-list">
                            ...
                            <a href="<?php echo _u('a-6999a2c2','link'); ?>" aria-current="page" class="footer-nav_link dropdown-child w-dropdown-link" data-text="tn73e4c4eb" data-link="a-6999a2c2"><?php echo _u('tn73e4c4eb','text'); ?></a>
                          </nav>
                        </div>
