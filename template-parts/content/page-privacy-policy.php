      ...
      <div class="padding-global">
        <div class="container-medium">
          <div class="policy-inner">
            <h1 class="heading-style-h2" data-text="tn3fbde6f6"><?php echo _u('tn3fbde6f6','text'); ?></h1>
            <div class="text-rich-text w-richtext" data-richtext="r64ed450c"><?php echo _u('r64ed450c', 'richtext'); ?></div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="footer_inner">
            ...
            <div class="footer_bottom">
              <ul role="list" class="footer_privacy_menu">
                <li>
                  <a href="<?php echo _u('a-1db89ce9','link'); ?>" aria-current="page" class="unstyle" data-text="tn3fbde6f6" data-link="a-1db89ce9"><?php echo _u('tn3fbde6f6','text'); ?></a>
                </li>
                <li>
