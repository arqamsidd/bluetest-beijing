...
.db-filter-tag .w-dyn-item:nth-last-child(1) .db-filtertag::after{
  content: '';
                      ...
                      <div class="navigation-drop-container products">
                        ...
                        <div class="product-menu-right">
                          <div class="product-menu_chambers">
                            ...
                            <?php get_template_part('template-parts/query/chambers-sorted-by-name-v2') ?>
                          </div>
                          <div class="product-menu_chambers">
                          ...
                          <div class="swiper-slides-container">
                            <div class="collection_featured swiper product-swiper">
                              <div class="swiper-wrapper">
                                <a href="<?php echo _u('af54e711','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide w-inline-block" data-link="af54e711">
              ...
              <nav class="dropdown-list-mob w-dropdown-list">
                <div class="navigation-link-block-mob">
                  <div class="nav-content-wrap">
                    <div class="product-menu_chambers">
                      <div class="heading-style-h5" data-text="t592afcb5"><?php echo _u('t592afcb5','text'); ?></div>
                      <?php get_template_part('template-parts/query/chambers-sorted-by-name-v3') ?>
                    </div>
                  ...
                  <div class="nav-content-wrap mob">
                    <div class="sectors-container">
                      <div class="swiper-slides-container">
                        <div class="collection_featured swiper product-swiper">
                          <div class="swiper-wrapper">
                            <a href="<?php echo _u('af54e711','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide squared w-inline-block" data-link="af54e711">
                              <div class="sector_featured_image"><img src="<?php echo udesly_get_image(_u('in33e257ca', 'img'))->src ?>" loading="lazy" alt="<?php echo udesly_get_image(_u('in33e257ca', 'img'))->alt ?>" class="sector_featured_image-img" data-img="in33e257ca" srcset="<?php echo udesly_get_image(_u('in33e257ca', 'img'))->srcset ?>"></div>
                              <div class="sector_slider_content">
                                <div class="heading-style-h4 sectorcard-heading" data-text="tn758e945c"><?php echo _u('tn758e945c','text'); ?></div>
                                <div class="global-icon-x-small sectorcard w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <div class="home-hero hero-logo">
      <div class="fixed-bg black"><img src="<?php echo udesly_get_image(_u('in5a0ac9c5', 'img'))->src ?>" loading="lazy" width="1376" sizes="(max-width: 1919px) 100vw, 1376px" alt="<?php echo udesly_get_image(_u('in5a0ac9c5', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('in5a0ac9c5', 'img'))->srcset ?>" class="fixed-bg_img opacity" data-img="in5a0ac9c5"></div>
      <div class="padding-global">
        <div class="container-large">
          <div class="home-hero_inner">
            <div class="home-hero_inner_bottom">
              <h1 id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49ef-ff34cc50" class="heading-style-h1 max-width-large" data-text="t5f35d8f1"><?php echo _u('t5f35d8f1','text'); ?></h1>
              <div id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f1-ff34cc50" class="home-hero_inner_bottom_right">
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f2-ff34cc50" href="<?php echo _u('a38b72420','link'); ?>" class="button is-icon hero w-inline-block" data-link="a38b72420">
                  <div data-textarea="tan1ffd4005"><?php echo _u('tan1ffd4005', 'textarea'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <title>Arrow Right</title>
                      <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                    </polygon></svg></div>
                </a>
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6-ff34cc50" data-w-id="ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6" href="<?php echo _u('a-30e216c9','link'); ?>" class="button is-icon gray special w-inline-block" data-link="a-30e216c9">
                  <div data-text="t2dd2a97b"><?php echo _u('t2dd2a97b','text'); ?></div>
                  <div class="global-icon-x-small hidemob w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <mask id="mask0_2936_12501" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="16" height="16">
                        <rect width="16" height="16" fill="currentColor"></rect>
                      </mask>
                      <g mask="url(#mask0_2936_12501)">
    ...
    <div class="text-image">
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner"><img src="<?php echo udesly_get_image(_u('in7b3d3c17', 'img'))->src ?>" loading="lazy" width="964" sizes="(max-width: 991px) 100vw, 964px" alt="<?php echo udesly_get_image(_u('in7b3d3c17', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('in7b3d3c17', 'img'))->srcset ?>" class="text-image_img" data-img="in7b3d3c17">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="tn75dec764"><?php echo _u('tn75dec764','text'); ?></h2>
              <div data-textarea="tan1a02e641"><?php echo _u('tan1a02e641', 'textarea'); ?></div>
              <div class="text-image_text_bottom">
                ...
                <a href="<?php echo _u('a-30e216c9','link'); ?>" target="_blank" class="button is-text w-inline-block" data-link="a-30e216c9">
                  <div data-text="tnd468c53"><?php echo _u('tnd468c53','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <title>Arrow Right</title>
                      <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                    </polygon></svg></div>
      ...
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner reversed">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="t4c4b3ef5"><?php echo _u('t4c4b3ef5','text'); ?></h2>
              <div data-textarea="tan419f39e1"><?php echo _u('tan419f39e1', 'textarea'); ?></div>
              <div class="text-image_text_bottom">
                <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                  <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
            ...
            </div><img src="<?php echo udesly_get_image(_u('i7270717', 'img'))->src ?>" loading="lazy" id="w-node-_2e37cf8f-8954-61ec-1673-1616b59e6c56-ff34cc50" sizes="(max-width: 3239px) 100vw, 3239px" alt="<?php echo udesly_get_image(_u('i7270717', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i7270717', 'img'))->srcset ?>" class="text-image_img" data-img="i7270717">
          </div>
        </div>
      </div>
    </div>
    <div class="solutions-slider">
      <div class="padding-global">
        <div class="container-large padding-section-medium">
          <h2 animated="" class="heading-style-h1 max-width-xlarge" data-text="tn273b05e2"><?php echo _u('tn273b05e2','text'); ?></h2>
          <div class="solutions-container">
            <div class="swiper-slides-container">
              <div class="collection_featured swiper product-swiper">
                <div class="swiper-wrapper">
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs">
                      <div class="industry-card_image"><img src="<?php echo udesly_get_image(_u('in1ff0506a', 'img'))->src ?>" loading="lazy" sizes="100vw" srcset="<?php echo udesly_get_image(_u('in1ff0506a', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('in1ff0506a', 'img'))->alt ?>" class="industry-slider-card_img" data-img="in1ff0506a">
                        <div class="industry-card_tags"></div>
                      </div>
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="tn305f49bd"><?php echo _u('tn305f49bd','text'); ?></h3>
                        <div data-text="t441b7db5"><?php echo _u('t441b7db5','text'); ?></div>
                        <div class="industry-card_buttons">
                          ...
                          <a href="<?php echo _u('a-30e216c9','link'); ?>" class="button is-text w-inline-block" data-link="a-30e216c9">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs">
                      <div class="industry-card_image"><img src="<?php echo udesly_get_image(_u('i66b669df', 'img'))->src ?>" loading="lazy" alt="<?php echo udesly_get_image(_u('i66b669df', 'img'))->alt ?>" class="industry-slider-card_img" data-img="i66b669df" srcset="<?php echo udesly_get_image(_u('i66b669df', 'img'))->srcset ?>">
                        <div class="industry-card_tags"></div>
                      </div>
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="tn1381bcf1"><?php echo _u('tn1381bcf1','text'); ?></h3>
                        <div data-text="tn41c2d78f"><?php echo _u('tn41c2d78f','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs">
                      <div class="industry-card_image"><img src="<?php echo udesly_get_image(_u('in2a5582ec', 'img'))->src ?>" loading="lazy" sizes="(max-width: 3239px) 100vw, 3239px" srcset="<?php echo udesly_get_image(_u('in2a5582ec', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('in2a5582ec', 'img'))->alt ?>" class="industry-slider-card_img" data-img="in2a5582ec">
                        <div class="industry-card_tags"></div>
                      </div>
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="tn4fe31d77"><?php echo _u('tn4fe31d77','text'); ?></h3>
                        <div data-text="tneb3cc10"><?php echo _u('tneb3cc10','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs">
                      <div class="industry-card_image"><img src="<?php echo udesly_get_image(_u('in36476f45', 'img'))->src ?>" loading="lazy" alt="<?php echo udesly_get_image(_u('in36476f45', 'img'))->alt ?>" class="industry-slider-card_img" data-img="in36476f45" srcset="<?php echo udesly_get_image(_u('in36476f45', 'img'))->srcset ?>">
                        <div class="industry-card_tags">
                          <div class="hide" data-text="tnd32bd50"><?php echo _u('tnd32bd50','text'); ?></div>
                          <div class="industry-pill hide" data-text="t4aaf454"><?php echo _u('t4aaf454','text'); ?></div>
                        </div>
                      </div>
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="tn7b34e2e7"><?php echo _u('tn7b34e2e7','text'); ?></h3>
                        <div data-text="tn7f880e3f"><?php echo _u('tn7f880e3f','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="media-card">
      <div class="padding-global">
        <div class="container-large black">
          <div class="media-card_bg"><img src="<?php echo udesly_get_image(_u('i3bd55d9', 'img'))->src ?>" loading="lazy" alt="<?php echo udesly_get_image(_u('i3bd55d9', 'img'))->alt ?>" class="media-card_img opacity-less" data-img="i3bd55d9" srcset="<?php echo udesly_get_image(_u('i3bd55d9', 'img'))->srcset ?>"></div>
          <div class="media-card_inner">
            <div class="media-card_content">
              <h2 animated="" class="fancy-h1" data-text="tn270deb39"><?php echo _u('tn270deb39','text'); ?></h2>
              <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                    <title>Arrow Right</title>
    ...
    <div class="whitepapers-loop">
      <div class="padding-global">
        <div class="container-large">
          <div class="related-news_top">
            <h2 animated="" class="heading-style-h1 max-width-large" data-text="t4a42e442"><?php echo _u('t4a42e442','text'); ?></h2>
            <a href="<?php echo _u('a63dd000','link'); ?>" target="_blank" class="button is-text black w-inline-block" data-link="a63dd000">
              <div data-text="tn17655669"><?php echo _u('tn17655669','text'); ?></div>
              <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  <title>Arrow Right</title>
                  <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                </polygon></svg></div>
          ...
          <?php get_template_part('template-parts/query/news-max-3-sorted-by-date') ?>
        </div>
      </div>
    </div>
    <div animated="" class="partner-logos gray hide">
      <div class="padding-global">
        <div class="container-large">
          <div class="partner-logos_inner padding-section-small">
            <h2 class="heading-style-h5" data-text="tn42d4c927"><?php echo _u('tn42d4c927','text'); ?></h2>
            <div class="marquee_outer">
              <div class="marquee_wrap">
                <?php get_template_part('template-parts/query/client-logos') ?>
                <?php get_template_part('template-parts/query/client-logos') ?>
              </div>
            </div>
          </div>
                    ...
                    <div data-animation="default" data-collapse="none" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="footer-nav_wrap w-nav">
                      <nav role="navigation" class="footer-nav w-nav-menu">
                        ...
                        <div data-hover="false" data-delay="0" class="dropdown-2 w-dropdown">
                          ...
                          <nav class="footer-nav_dropdown w-dropdown-list">
                            <a href="<?php echo _u('af54e711','link'); ?>" aria-current="page" class="footer-nav_link dropdown-child w-dropdown-link" data-text="tn530b3473" data-link="af54e711"><?php echo _u('tn530b3473','text'); ?></a>
