...
.db-filter-tag .w-dyn-item:nth-last-child(1) .db-filtertag::after{
  content: '';
                          ...
                          <div class="swiper-slides-container">
                            <div class="collection_featured swiper product-swiper">
                              <div class="swiper-wrapper">
                                ...
                                <a href="<?php echo _u('a5621714b','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide w-inline-block" data-link="a5621714b">
                      ...
                      <div class="swiper-slides-container">
                        <div class="collection_featured swiper product-swiper">
                          <div class="swiper-wrapper">
                            ...
                            <a href="<?php echo _u('a5621714b','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide squared w-inline-block" data-link="a5621714b">
                              <div class="sector_featured_image"><img src="<?php echo udesly_get_image(_u('in3e288117', 'img'))->src ?>" loading="lazy" sizes="100vw" srcset="<?php echo udesly_get_image(_u('in3e288117', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('in3e288117', 'img'))->alt ?>" class="sector_featured_image-img" data-img="in3e288117"></div>
                              <div class="sector_slider_content">
                                <div class="heading-style-h4 sectorcard-heading" data-text="tn3c25ad95"><?php echo _u('tn3c25ad95','text'); ?></div>
                                <div class="global-icon-x-small sectorcard w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <div class="home-hero hero-logo">
      <div class="fixed-bg"><img src="<?php echo udesly_get_image(_u('i6bde0692', 'img'))->src ?>" loading="lazy" width="1619.5" sizes="(max-width: 1919px) 100vw, 1620px" alt="<?php echo udesly_get_image(_u('i6bde0692', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i6bde0692', 'img'))->srcset ?>" class="fixed-bg_img" data-img="i6bde0692"></div>
      <div class="padding-global">
        <div class="container-large">
          <div class="home-hero_inner">
            <div class="home-hero_inner_bottom">
              <h1 id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49ef-b105e729" class="heading-style-h1 max-width-large" data-text="t2cf03b4d"><?php echo _u('t2cf03b4d','text'); ?></h1>
              <div id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f1-b105e729" class="home-hero_inner_bottom_right">
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f2-b105e729" href="<?php echo _u('a38b72420','link'); ?>" class="button is-icon hero special w-inline-block" data-link="a38b72420">
                  <div data-text="t7f2746de"><?php echo _u('t7f2746de','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <title>Arrow Right</title>
                      <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                ...
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6-b105e729" data-w-id="ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6" href="<?php echo _u('a6084ccde','link'); ?>" class="button is-icon gray special w-inline-block" data-link="a6084ccde">
    ...
    <div class="text-image">
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner"><img src="<?php echo udesly_get_image(_u('i53a49b', 'img'))->src ?>" loading="lazy" sizes="(max-width: 3239px) 100vw, 3239px" srcset="<?php echo udesly_get_image(_u('i53a49b', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('i53a49b', 'img'))->alt ?>" class="text-image_img" data-img="i53a49b">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="tn3bf8bb78"><?php echo _u('tn3bf8bb78','text'); ?></h2>
              <div data-textarea="tan336701a0"><?php echo _u('tan336701a0', 'textarea'); ?></div>
      ...
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner reversed">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="tn756a5b8b"><?php echo _u('tn756a5b8b','text'); ?></h2>
              <div data-textarea="ta70eddc43"><?php echo _u('ta70eddc43', 'textarea'); ?></div>
              <div class="text-image_text_bottom">
                <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                  <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
            ...
            </div><img src="<?php echo udesly_get_image(_u('in32ddbe07', 'img'))->src ?>" loading="lazy" id="w-node-_2e37cf8f-8954-61ec-1673-1616b59e6c56-b105e729" sizes="(max-width: 3239px) 100vw, 3239px" alt="<?php echo udesly_get_image(_u('in32ddbe07', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('in32ddbe07', 'img'))->srcset ?>" class="text-image_img" data-img="in32ddbe07">
          </div>
        </div>
      </div>
    </div>
    <div class="solutions-slider">
      <div class="padding-global">
        <div class="container-large padding-section-medium">
          <h2 animated="" class="heading-style-h1 max-width-xlarge" data-text="tn4b389f1e"><?php echo _u('tn4b389f1e','text'); ?></h2>
              ...
              <div class="collection_featured swiper product-swiper">
                <div class="swiper-wrapper">
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="t53eac40d"><?php echo _u('t53eac40d','text'); ?></h3>
                        <div data-text="tn45339f16"><?php echo _u('tn45339f16','text'); ?></div>
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="t1aa27766"><?php echo _u('t1aa27766','text'); ?></h3>
                        <div data-text="t48758bd8"><?php echo _u('t48758bd8','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="tn3fc0ad4d"><?php echo _u('tn3fc0ad4d','text'); ?></h3>
                        <div data-text="tn38364864"><?php echo _u('tn38364864','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="t56b7f74f"><?php echo _u('t56b7f74f','text'); ?></h3>
                        <div data-text="t3f88d962"><?php echo _u('t3f88d962','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3" data-text="t1078c675"><?php echo _u('t1078c675','text'); ?></h3>
                        <div data-text="tn76cce673"><?php echo _u('tn76cce673','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="media-card">
      <div class="padding-global">
        <div class="container-large">
          <div class="media-card_bg"><img src="<?php echo udesly_get_image(_u('in6b2daa86', 'img'))->src ?>" loading="lazy" sizes="(max-width: 3239px) 100vw, 3239px" srcset="<?php echo udesly_get_image(_u('in6b2daa86', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('in6b2daa86', 'img'))->alt ?>" class="media-card_img" data-img="in6b2daa86"></div>
          <div class="media-card_inner">
            <div class="media-card_content">
              <h2 animated="" class="fancy-h1" data-text="tn7ea06028"><?php echo _u('tn7ea06028','text'); ?></h2>
              <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                    <title>Arrow Right</title>
                      ...
                      <nav role="navigation" class="footer-nav w-nav-menu">
                        ...
                        <div data-hover="false" data-delay="0" class="dropdown-2 w-dropdown">
                          ...
                          <nav class="footer-nav_dropdown w-dropdown-list">
                            ...
                            <a href="<?php echo _u('a5621714b','link'); ?>" aria-current="page" class="footer-nav_link dropdown-child w-dropdown-link" data-text="tn4b8f3e15" data-link="a5621714b"><?php echo _u('tn4b8f3e15','text'); ?></a>
