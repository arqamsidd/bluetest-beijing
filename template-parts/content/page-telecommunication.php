...
.db-filter-tag .w-dyn-item:nth-last-child(1) .db-filtertag::after{
  content: '';
                          ...
                          <div class="swiper-slides-container">
                            <div class="collection_featured swiper product-swiper">
                              <div class="swiper-wrapper">
                                ...
                                <a href="<?php echo _u('a-5bffa1fd','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide w-inline-block" data-link="a-5bffa1fd">
                      ...
                      <div class="swiper-slides-container">
                        <div class="collection_featured swiper product-swiper">
                          <div class="swiper-wrapper">
                            ...
                            <a href="<?php echo _u('a-5bffa1fd','link'); ?>" aria-current="page" class="collection_featured-item swiper-slide squared w-inline-block" data-link="a-5bffa1fd">
    ...
    <div class="home-hero hero-logo">
      <div class="fixed-bg"><img src="<?php echo udesly_get_image(_u('i38a3911a', 'img'))->src ?>" loading="lazy" width="1619.5" sizes="(max-width: 1919px) 100vw, 1620px" alt="<?php echo udesly_get_image(_u('i38a3911a', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i38a3911a', 'img'))->srcset ?>" class="fixed-bg_img" data-img="i38a3911a"></div>
      <div class="padding-global">
        <div class="container-large">
          <div class="home-hero_inner">
            <div class="home-hero_inner_bottom">
              <h1 id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49ef-5994d30b" class="heading-style-h1 max-width-large" data-text="tn51b6f5e"><?php echo _u('tn51b6f5e','text'); ?></h1>
              <div id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f1-5994d30b" class="home-hero_inner_bottom_right">
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f2-5994d30b" href="<?php echo _u('a38b72420','link'); ?>" class="button is-icon hero special w-inline-block" data-link="a38b72420">
                  <div data-text="t7f2746de"><?php echo _u('t7f2746de','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                      <title>Arrow Right</title>
                      <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                ...
                <a id="w-node-ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6-5994d30b" data-w-id="ce196bb4-6e3f-76e7-5ed8-4fffc9dc49f6" href="<?php echo _u('a6084ccde','link'); ?>" class="button is-icon gray special w-inline-block" data-link="a6084ccde">
    ...
    <div class="text-image">
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner"><img src="<?php echo udesly_get_image(_u('i3f76f396', 'img'))->src ?>" loading="lazy" sizes="(max-width: 3239px) 100vw, 3239px" srcset="<?php echo udesly_get_image(_u('i3f76f396', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('i3f76f396', 'img'))->alt ?>" class="text-image_img" data-img="i3f76f396">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="t656b88c1"><?php echo _u('t656b88c1','text'); ?></h2>
              <div data-textarea="tan414066b5"><?php echo _u('tan414066b5', 'textarea'); ?></div>
      ...
      <div class="padding-global">
        <div class="container-large">
          <div class="text-image_inner reversed">
            <div class="text-image_text">
              <h2 class="heading-style-h3" data-text="tn2de88f9"><?php echo _u('tn2de88f9','text'); ?></h2>
              <div data-textarea="tan6fa6e40c"><?php echo _u('tan6fa6e40c', 'textarea'); ?></div>
              <div class="text-image_text_bottom">
                <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                  <div data-text="t7f274abe"><?php echo _u('t7f274abe','text'); ?></div>
                  <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
            ...
            </div><img src="<?php echo udesly_get_image(_u('i65121668', 'img'))->src ?>" loading="lazy" id="w-node-_2e37cf8f-8954-61ec-1673-1616b59e6c56-5994d30b" sizes="(max-width: 3240px) 100vw, 3240px" alt="<?php echo udesly_get_image(_u('i65121668', 'img'))->alt ?>" srcset="<?php echo udesly_get_image(_u('i65121668', 'img'))->srcset ?>" class="text-image_img" data-img="i65121668">
          </div>
        </div>
      </div>
    </div>
    <div class="solutions-slider">
      <div class="padding-global">
        <div class="container-large padding-section-medium">
          <h2 class="heading-style-h1 max-width-xlarge" data-text="t6d20e7ef"><?php echo _u('t6d20e7ef','text'); ?></h2>
          <div class="solutions-container">
            <div class="swiper-slides-container">
              <div class="collection_featured swiper product-swiper">
                <div class="swiper-wrapper">
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3 xs" data-text="t3e58ef26"><?php echo _u('t3e58ef26','text'); ?></h3>
                        <div data-text="t28dbfa23"><?php echo _u('t28dbfa23','text'); ?></div>
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3 xs" data-text="tn643feb62"><?php echo _u('tn643feb62','text'); ?></h3>
                        <div data-text="t6de9faf0"><?php echo _u('t6de9faf0','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3 xs" data-text="t22633ae1"><?php echo _u('t22633ae1','text'); ?></h3>
                        <div data-text="t2797fad4"><?php echo _u('t2797fad4','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3 xs" data-text="t5cfc618d"><?php echo _u('t5cfc618d','text'); ?></h3>
                        <div data-text="tn343b7782"><?php echo _u('tn343b7782','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3 xs" data-text="tn34ab4ceb"><?php echo _u('tn34ab4ceb','text'); ?></h3>
                        <div data-text="tn37dfb13c"><?php echo _u('tn37dfb13c','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="collection_featured-item swiper-slide">
                    <div class="industry-slider-card xs xss">
                      <div class="industry-slider-card_content">
                        <h3 class="heading-style-h3 xs" data-text="tn46b2e3b9"><?php echo _u('tn46b2e3b9','text'); ?></h3>
                        <div data-text="tn2c4c2fca"><?php echo _u('tn2c4c2fca','text'); ?></div>
                        <div class="industry-card_buttons">
                          <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                            <div data-text="tn5230a9d2"><?php echo _u('tn5230a9d2','text'); ?></div>
                            <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="media-card">
      <div class="padding-global">
        <div class="container-large black">
          <div class="media-card_bg"><img src="<?php echo udesly_get_image(_u('in60f096cc', 'img'))->src ?>" loading="lazy" sizes="(max-width: 3527px) 100vw, 3527px" srcset="<?php echo udesly_get_image(_u('in60f096cc', 'img'))->srcset ?>" alt="<?php echo udesly_get_image(_u('in60f096cc', 'img'))->alt ?>" class="media-card_img opacity-less" data-img="in60f096cc"></div>
          <div class="media-card_inner">
            <div class="media-card_content">
              <h2 class="fancy-h1" data-text="tn5c6cc151"><?php echo _u('tn5c6cc151','text'); ?></h2>
              <div data-text="tn4cf925c2"><?php echo _u('tn4cf925c2','text'); ?></div>
              <a href="<?php echo _u('a38b72420','link'); ?>" target="_blank" class="button is-icon w-inline-block" data-link="a38b72420">
                <div data-text="tn1ffd4005"><?php echo _u('tn1ffd4005','text'); ?></div>
                <div class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewBox="0 0 20 21" xmlns="http://www.w3.org/2000/svg">
                    <title>Arrow Right</title>
                    <polygon points="16.172 9 10.101 2.929 11.515 1.515 20 10 19.293 10.707 11.515 18.485 10.101 17.071 16.172 11 0 11 0 9">
                  </polygon></svg></div>
                      ...
                      <nav role="navigation" class="footer-nav w-nav-menu">
                        ...
                        <div data-hover="false" data-delay="0" class="dropdown-2 w-dropdown">
                          ...
                          <nav class="footer-nav_dropdown w-dropdown-list">
                            ...
                            <a href="<?php echo _u('a-5bffa1fd','link'); ?>" aria-current="page" class="footer-nav_link dropdown-child w-dropdown-link" data-text="te063d77" data-link="a-5bffa1fd"><?php echo _u('te063d77','text'); ?></a>
